...
type ProjectHeaderProps = { title: string; liveLink: string; repoLink: string };
export const ProjectHeader = ({
  title,
  liveLink,
  repoLink,
}: ProjectHeaderProps): ReactElement => {
  const isClickable = liveLink === "#" ? false : true;
  return (
        ...
        {isClickable && (
          <>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-7 h-7 hover:scale-110 cursor-pointer active:scale-90"
            >
