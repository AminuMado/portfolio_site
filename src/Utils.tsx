...
export const SkillTag = ({ name }: SkillTagProps): ReactElement => {
  let icon: React.SVGAttributes<SVGSVGElement>;
  switch (name) {
    case "React":
      icon = (
    ...
    default:
      icon = (
        <svg viewBox="0 0 128 128">
          <path d="M96.8 25.6H107v51.2H96.8zM71.2 25.6h10.2V128H71.2zM45.6 25.6h10.2V128H45.6zM20 0h10.2v76.8H20z"></path>
        </svg>
      );
      break;
  }
  ...
  return (
    <div className=" w-fit text-primary-color bg-card-color hover:scale-105 py-1 px-2 m-1 rounded-lg  flex flex-1  items-center justify-center gap-1 cursor-default ">
      <>{icon}</>
      <span>{name}</span>
    </div>
  );
